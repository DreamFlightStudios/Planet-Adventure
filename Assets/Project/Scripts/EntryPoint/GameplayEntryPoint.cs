...
{
    [Inject]
    private void Construct(RootControllerUI uiScreens, PauseMenuControllerUI pauseMenuUI, WarningIndicator warningIndicatorUI, SubtilesUI subtiles, SceneLoader sceneLoader, InputSystem input)
    {
